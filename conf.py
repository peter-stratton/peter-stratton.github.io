...
BLOG_AUTHOR = "Peter Stratton"  # (translatable)
BLOG_TITLE = "Peter Stratton"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://peterstratton.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://peterstratton.com/"
BLOG_EMAIL = "peter.stratton@halescode.com"
BLOG_DESCRIPTION = "Pushing pixels, popping stacks."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "peterstratton"
